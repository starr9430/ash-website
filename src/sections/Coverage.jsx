    ...
    <section className="products-section" id="products">
      <div className="products-intro">
        ...
        <p className="products-copy">
          From core clutch assemblies to supporting release components, ASH brings practical coverage together for passenger cars, light commercial vehicles, and selected commercial applications.
        </p>
